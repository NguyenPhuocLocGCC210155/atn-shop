...
class Staff implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[ORM\OneToMany(mappedBy: 'staff', targetEntity: Cart::class)]
    private Collection $cart;

    #[ORM\OneToMany(mappedBy: 'staff', targetEntity: Storage::class)]
    private Collection $storage;

    #[ORM\OneToMany(mappedBy: 'st', targetEntity: Storage::class)]
    ...
    public function addStaff(Storage $staff): static
    {
    ...
    public function removeStaff(Storage $staff): static
    {
